    ...
    <>
      <Card>
        ...
        <CardActions>
          ...
          <Button size="small" variant="contained" onClick={handleOpen} sx={{
            backgroundColor: '#FF7505', '&:hover': {
              color: '#FF7505', backgroundColor: '#FFFFFF'
            },
          }}>Criar Tarefa</Button>

          <Button size="small" variant="outlined" sx={{
            color: '#FF7505', borderColor: '#FF7505', '&:hover': {
              borderColor: '#FF7505'
            },
          }}>Cancelar</Button>
